...
import { renderPlaceView, createConeColorPicker } from "./placeview.js?v=10";
...
function openVolcano(feature, layer) {
  if (isTomographyMap) {
    ...
    if (name) window.location.href = `../measurement/tomography-models/viewer.html?volcano=${name}&v=55`;
    return;
  }
...
fetch("resources/volcanoes.geojson")
  ...
  .then((data) => {
    ...
    if (isTomographyMap) {
      ...
      uploadBtn.href = "../measurement/tomography-models/index.html?v=63";
      uploadBtn.innerHTML = `
